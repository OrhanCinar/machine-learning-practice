    ...
    def __init__(self, state_size, action_size, learning_rate, name="PQNetwork"):
        ...
        with tf.variable_scope(name):
            ...
            with tf.name_scope("conv2"):
              """
               ...
               self.conv2_batchnorm = tf.layers.batch_normalization(self.conv2,
                                                                     ...
                                                                     epsilon = 1e-5,
                                                                     name = "batch_norm2")
               self.conv2_out = tf.nn.elu(self.conv1_batchnorm, name = "conv2_out")     ## --> [9, 9, 64]
            ...
            with tf.name_scope("conv3"):
              """
               ...
               self.conv3_batchnorm = tf.layers.batch_normalization(self.conv2,
                                                                     ...
                                                                     epsilon = 1e-5,
                                                                     name = "batch_norm3")
               self.conv3_out = tf.nn.elu(self.conv1_batchnorm, name = "conv3_out")     ## --> [3, 3, 128]
            ...
            with tf.name_scope("traing"):
                self.train_opt = tf.trains.RMSPropOptimizer(self.learning_rate).minimize(self.loss)
